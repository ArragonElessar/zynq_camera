# 0 "/home/pruparel/Projects/FPGA/camera/application/camera_platform/hw/sdt/system-top.dts"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/home/pruparel/Projects/FPGA/camera/application/camera_platform/hw/sdt/system-top.dts"
/dts-v1/;
# 1 "/home/pruparel/Projects/FPGA/camera/application/camera_platform/hw/sdt/zynq-7000.dtsi" 1
# 10 "/home/pruparel/Projects/FPGA/camera/application/camera_platform/hw/sdt/zynq-7000.dtsi"
/ {
 #address-cells = <1>;
 #size-cells = <1>;
...
# 3 "/home/pruparel/Projects/FPGA/camera/application/camera_platform/hw/sdt/system-top.dts" 2
# 1 "/home/pruparel/Projects/FPGA/camera/application/camera_platform/hw/sdt/pl.dtsi" 1
/ {
 amba_pl: amba_pl {
  ranges;
  compatible = "simple-bus";
  #address-cells = <1>;
  #size-cells = <1>;
  firmware-name = "camera_hardware.bit.bin";
  clocking0: clocking0 {
  ...
  camera_control: gpio@41210000 {
   ...
   xlnx,name = "camera_control";
   xlnx,all-inputs = <0>;
  };
  camera_iic: i2c@41600000 {
   interrupts = < 0 29 4 >;
   ...
   xlnx,name = "camera_iic";
   xlnx,axi-aclk-freq-mhz = <0x5f5e095>;
   xlnx,sda-inertial-delay = <0>;
  };
  clk_locked_gpio: gpio@41220000 {
   xlnx,gpio-board-interface = "Custom";
   compatible = "xlnx,axi-gpio-2.0" , "xlnx,xps-gpio-1.00.a";
   xlnx,all-outputs = <0>;
   #gpio-cells = <2>;
   ...
   clock-names = "s_axi_aclk";
   xlnx,tri-default = <0xffffffff>;
   xlnx,name = "clk_locked_gpio";
   xlnx,all-inputs = <1>;
  };
  led_control: gpio@41200000 {
   xlnx,gpio-board-interface = "Custom";
   compatible = "xlnx,axi-gpio-2.0" , "xlnx,xps-gpio-1.00.a";
   xlnx,all-outputs = <1>;
   #gpio-cells = <2>;
   ...
   clock-names = "s_axi_aclk";
   xlnx,tri-default = <0xffffffff>;
   xlnx,name = "led_control";
   xlnx,all-inputs = <0>;
  };
 };
};
# 4 "/home/pruparel/Projects/FPGA/camera/application/camera_platform/hw/sdt/system-top.dts" 2
# 1 "/home/pruparel/Projects/FPGA/camera/application/camera_platform/hw/sdt/pcw.dtsi" 1
 &ps7_cortexa9_0 {
  xlnx,i-cache-size = <0x8000>;
  xlnx,d-cache-line-size = <20>;
  xlnx,i-cache-line-size = <20>;
  xlnx,cpu-1x-clk-freq-hz = <111111000>;
  xlnx,ip-name = "ps7_cortexa9";
  xlnx,d-cache-size = <0x8000>;
  xlnx,num-cores = <2>;
  xlnx,cpu-clk-freq-hz = <666665955>;
  bus-handle = <&amba>;
 };
 &ps7_cortexa9_1 {
  xlnx,i-cache-size = <0x8000>;
 ...
 &uart0 {
  status = "okay";
  xlnx,clock-freq = <99999893>;
  xlnx,has-modem = <0>;
  xlnx,ip-name = "ps7_uart";
  cts-override;
  port-number = <0>;
  xlnx,uart-clk-freq-hz = <99999893>;
  xlnx,name = "ps7_uart_0";
 };
 &qspi {
  xlnx,qspi-fbclk = <0>;
  num-cs = <1>;
  xlnx,qspi-clk-freq-hz = <199999786>;
  xlnx,bus-width = <2>;
 ...
 &sdhci0 {
  ...
  xlnx,sdio-clk-freq-hz = <49999947>;
  xlnx,has-wp = <1>;
  xlnx,has-cd = <1>;
  xlnx,name = "ps7_sd_0";
 };
 &ttc0 {
  xlnx,ttc-clk2-freq-hz = <111111000>;
  xlnx,ttc-clk1-clksrc = <0>;
  status = "okay";
  xlnx,clock-freq = <111111000>;
  xlnx,ttc-clk2-clksrc = <0>;
  xlnx,ip-name = "ps7_ttc";
  xlnx,ttc-clk0-freq-hz = <111111000>;
  xlnx,ttc-clk1-freq-hz = <111111000>;
 ...
 &mc {
  status = "okay";
  xlnx,ddr-clk-freq-hz = <266666411>;
...
# 5 "/home/pruparel/Projects/FPGA/camera/application/camera_platform/hw/sdt/system-top.dts" 2
/ {
 board = "edgez7_20";
 compatible = "xlnx,edgez7_20";
 device_id = "7z020";
 slrcount = <1>;
 family = "Zynq";
 speed_grade = "1";
 ...
 cpus_a9: cpus-a9@0 {
  ...
  address-map = <0xf0000000 &amba 0xf0000000 0x10000000>,
         ...
         <0x41200000 &led_control 0x41200000 0x10000>,
         <0x41210000 &camera_control 0x41210000 0x10000>,
         <0x41220000 &clk_locked_gpio 0x41220000 0x10000>,
         <0x41600000 &camera_iic 0x41600000 0x10000>,
